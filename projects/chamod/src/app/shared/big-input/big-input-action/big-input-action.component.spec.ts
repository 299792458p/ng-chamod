...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<chamod-big-input-action></chamod-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<chamod-big-input-action [disabled]="true"></chamod-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<chamod-big-input-action fontSet="fas" fontIcon="fa-trash"></chamod-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<chamod-big-input-action label="delete"></chamod-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<chamod-big-input-action (action)="actionHandler()"></chamod-big-input-action>`;
    fixture = createHostComponent(template);
